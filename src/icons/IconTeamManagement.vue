  ...
  <IconBase viewBox="0 0 20 20">
    <g id="team-management">
      <g clip-path="url(#clip0)">
        ...
        />
        <path
          d="M19.1667 17.5001V15.8334C19.1662 15.0948 18.9204 14.3774 18.4679 13.7937C18.0154 13.2099 17.3819 12.793 16.6667 12.6084"
          stroke="currentColor"
          stroke-width="2"
          stroke-linecap="round"
          stroke-linejoin="round"
...
export default compose('IconTeamManagement')
</script>
